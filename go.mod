...
require (
	...
	github.com/bsv-blockchain/go-wallet-toolbox v0.184.17
...
require (
	...
	github.com/bsv-blockchain/go-bsv-middleware v0.15.0 // indirect
	...
	github.com/bsv-blockchain/go-teranode-p2p-client v0.2.9 // indirect
