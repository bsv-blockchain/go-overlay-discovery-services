...
require (
	github.com/bsv-blockchain/go-overlay-services v1.2.2
	github.com/bsv-blockchain/go-sdk v1.2.12
	github.com/bsv-blockchain/go-wallet-toolbox v0.159.0
...
require (
	...
	github.com/go-co-op/gocron/v2 v2.18.1 // indirect
