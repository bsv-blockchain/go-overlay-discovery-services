...
require (
	...
	github.com/bsv-blockchain/go-bt/v2 v2.6.6 // indirect
	...
	github.com/bsv-blockchain/go-wire v1.2.8 // indirect
	github.com/bsv-blockchain/teranode v0.15.2-beta-7 // indirect
