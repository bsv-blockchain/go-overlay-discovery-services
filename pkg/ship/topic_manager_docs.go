...
// This file contains the documentation for the SHIP topic manager, separated from the implementation
// to improve code organization and maintainability.
package ship

// TopicManagerDocumentation contains the comprehensive documentation for the SHIP topic manager.
// This documentation describes how the topic manager validates SHIP outputs and the requirements
